...
namespace Đồ_án_Web.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderDetailID,OrderID,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderDetailID,OrderID,Quantity,UnitPrice")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult OD()
        {
            var orders = db.Orders.Include(o => o.Customer);
            return PartialView("~/Views/Shared/OD.cshtml", orders);
        }
    }
}
